...
**648 tests · 5 CI gates · six gzip-budgeted packages (core ≤30 KB).** Quality signals are drift-gated and surfaced on the [status page](https://theme-registry.github.io/refract/status).
