...
"@theme-registry/refract-scss": patch
"@theme-registry/refract-json": patch
"@theme-registry/refract-styled-components": patch
"@theme-registry/refract-mcp": patch
---

Add `preview` — an opt-in, human-facing `preview.html` specimen of a built theme, the audience-flipped sibling of `guide`.
