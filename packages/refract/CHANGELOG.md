...
- 1168dec: Round filled specimens, and make it obvious which string is a class name and what it is for.
...
- 42b0ee8: Draw lengths at true size, and separate `base` from its variants everywhere.
...
- bbb64ad: Render layout recipes in the idiom their own section already uses for tokens.
